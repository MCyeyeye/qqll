...
const args = {
	jdNotify: false,
	pageSize: 12,
	cidsList: ["家用电器", "手机数码", "电脑办公", "家居家装","食品饮料", "母婴玩具", "生鲜美食", "家庭清洁"],
	typeList: ["普通试用", "闪电试用"],
	goodFilters: "教程@吉越@英语@杀虫@蟑螂@一柒@镜片@奶粉@水晶头@手机壳@电话卡@尿@汽车@win@上网卡@情趣@购房@定制@伤疤@钢化膜@保护膜@手机膜@吊坠@手机壳@汽车@刷头@流量卡@辅导@培训@机油@内裤".split('@'),
	minPrice: 30,
	maxSupplyCount: 10,
}
...
async function filterGoodList() {
	...
	const now = Date.now()
	const oneMoreDay = now + 800 * 60 * 60 * 1000
